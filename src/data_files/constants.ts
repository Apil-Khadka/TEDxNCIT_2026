...
export const INSIGHTS_SEO = {
  ...
  description: "Explore inspiring talks and ideas from TEDxNCIT. Our insights feature diverse perspectives to foster innovation and creativity in our community.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
...
export const HOMEPAGE_SEO = {
  ...
  description: "Join TEDxNCIT for a day of inspiring talks and innovative ideas. Discover the power of ideas worth spreading.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "WebPage",
...
export const CONTACT_SEO = {
  ...
  description: "Get in touch with TEDxNCIT for inquiries, collaborations, or more information about our events.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "ContactPage",
...
export const REGISTER_SEO = {
  ...
  description: "Secure your spot at TEDxNCIT and be part of an inspiring event filled with innovative ideas and powerful talks.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "Event",
    "name": "TEDxNCIT",
...
export const SPEAKERS_SEO = {
  ...
  description: "Meet the brilliant minds behind TEDxNCIT. Our speakers bring unique perspectives and stories to inspire change.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
...
export const TEAMS_SEO = {
  ...
  description: "Get to know the dedicated team behind TEDxNCIT. Together, we bring ideas worth spreading to life.",
  structuredData: {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
